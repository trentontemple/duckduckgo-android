...
class DefaultDownloadsRepositoryTest {
    ...
    fun before() {
        ...
        repository = DefaultDownloadsRepository(db)
    }
    ...
    fun whenUpdateDownloadItemByIdWithDownloadStatusAndContentLengthThenUpdateInDB() = runTest {
        ...
        val updatedStatus = DownloadStatus.FINISHED
    ...
    @Test
    fun whenUpdateDownloadItemByFileNameWithDownloadStatusAndContentLengthThenUpdateInDB() =
        runTest {
